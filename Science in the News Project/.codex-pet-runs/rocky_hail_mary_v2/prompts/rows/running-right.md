Create one horizontal animation strip for Codex pet `rocky-hail-mary`, state `running-right`.
...
Identity: same pet in every frame: Upgrade the existing Rocky built-in pet: preserve the compact rock-like Eridian companion identity, faceted gray-brown body, simple expressive eyes, stable palette, and established standard animations; add natural looking directions only.. Preserve silhouette, face, proportions, markings, palette, material, style, and props.
