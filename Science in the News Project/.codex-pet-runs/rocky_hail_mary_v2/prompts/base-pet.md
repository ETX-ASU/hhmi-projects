Create one clean full-body reference sprite for Codex pet Rocky.

Pet identity: Upgrade the existing Rocky built-in pet: preserve the compact rock-like Eridian companion identity, faceted gray-brown body, simple expressive eyes, stable palette, and established standard animations; add natural looking directions only..
